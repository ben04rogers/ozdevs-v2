    ...
    <section class="dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-2 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl dark:text-white"><span class="text-customBlue">Developers</span> in <span style="color: rgb(255, 199, 0);">Australia</span></h1>
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex justify-end">
                <img src="{{ url('img/people-two.svg') }}" class="h-[300px]">
            </div>
        </div>
    </section>

    <div class="container mx-auto mt-5">
        <h2 class="text-xl lg:text-2xl mb-5">Recently joined developers</h2>
