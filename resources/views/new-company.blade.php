    ...
    <div class="max-w-2xl mx-auto">
        ...
        <form action="{{ route('newCompany') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="staff_name" name="staff_name" value="{{ auth()->user()->name }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
