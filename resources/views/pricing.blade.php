    ...
    <div>
        <div class="mx-auto max-w-7xl px-2 lg:px-8">
            <div class="mx-auto max-w-2xl sm:text-center">
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Find talented developers in Australia</h2>
            ...
            <div class="bg-white mx-auto mt-8 md:mt-14 max-w-2xl rounded-lg ring-1 ring-gray-200 lg:mx-0 lg:flex lg:max-w-none">
                <div class="p-8 sm:p-10 lg:flex-auto">
                    <h3 class="text-2xl font-bold tracking-tight text-gray-900">Save time & money</h3>
