...
@section("content")
    <div>
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="bg-white mx-auto mt-14 max-w-2xl rounded-lg ring-1 ring-gray-200 lg:mx-0 lg:flex lg:max-w-none">
                ...
                <div class="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <div class="mb-10">
                            ...
                            <p class="text-gray-500 dark:text-gray-400">Send an email to the owner at ben@ozdevs.com and I will get back to you as soon as possible.</p>
                        </div>
                    </div>
                </div>
            </div>
